...
/*   Updated: 2022/12/07 21:05:34 by moulmado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_sides(t_cub *cub)
{
	...
	grid_i = (cub->player->y + sin(cub->player->rotation_angle
		+ cub->player->walk_angle + M_PI_2) * move_step) / BLOCK_SIZE;
	grid_j = (cub->player->x +cos(cub->player->rotation_angle
		+ cub->player->walk_angle + M_PI_2) * move_step) / BLOCK_SIZE;
